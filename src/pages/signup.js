    ...
    return (
        <Fragment>
            <div className="min-h-screen flex flex-col justify-center" style={{backgroundImage: `url(${signupImg})`, backgroundRepeat: "no-repeat"}}>
                <div className="w-full h-screen flex items-center justify-center relative px-2 sm:px-4 py-10 bg-white sm:p-20 bg-clip-padding bg-opacity-60" style={{backdropFilter: `blur(10px)`}}>
